...
import insertCase from '@salesforce/apex/LargeFileUploadLgtng.insertCase';
import saveChunk from '@salesforce/apex/LargeFileUploadLgtng.saveChunk';
...
export default class CustomFileUploader extends LightningElement {
    ...
    /*uploadInChunk(this.file,this.fileContents,this.startPosition,this.endPosition,this.attachId){
        console.log('inside uploadInChunk');
        this.saveToChunk();
    }*/
